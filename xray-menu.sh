...
add_ssh() {
    ...
    echo -e "\033[0;31m━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[33m"
    echo -e "🔰ChiyemiV3 SCRIPT  !! "
    echo -e " SCRIPT ChiyemiV3 TIDAK MEMBENARKAN "
    echo -e "(SEPERTI DIBAWAH)"
    echo -e "❌  Torrent  "
    echo -e "❌  PS4 "
    echo -e "❌  Porn "
    echo -e "❌  Ddos Server "
...
END
    ...
    bash <(curl -sSL https://raw.githubusercontent.com/ChiyemiV3/multi/main/ceknet.sh)
...
backup_vps() {
    ...
    LLatest=$(date)
    Get_Data() {
        git clone https://github.com/ChiyemiV3/user-backup-db.git /root/user-backup/ &>/dev/null
    }
...
" >>/root/user-backup/$Name/$Name-last-backup
    ...
    Save_And_Exit() {
        cd /root/user-backup
        git config --global user.email "chiyemiv3@gmail.com" &>/dev/null
        git config --global user.name "ChiyemiV3" &>/dev/null
        rm -rf .git &>/dev/null
        git init &>/dev/null
        git add . &>/dev/null
        git commit -m m &>/dev/null
        git branch -M main &>/dev/null
        git remote add origin https://github.com/ChiyemiV3/user-backup-db
        git push -f https://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@github.com/NIIZAMKK/user-backup-db.git &>/dev/null
    }
    ...
    link="https://raw.githubusercontent.com/ChiyemiV3/user-backup-db/main/$Name/$Name.zip"
    sleep 1
...
IZIN=$(curl https://raw.githubusercontent.com/ChiyemiV3/access/main/ip | grep $MYIP | awk '{print $4}')
# CLIENT INFOMATION
name=$(curl -sS https://raw.githubusercontent.com/ChiyemiV3/access/main/ip | grep $IPVPS | awk '{print $2}')
exp=$(curl -sS https://raw.githubusercontent.com/ChiyemiV3/access/main/ip | grep $IPVPS | awk '{print $3}')
...
echo -e "\e[0;32m Telegram Own        : @mesakuraairiv3 "
echo -e "\e[0;32m Script Version      : (4.0 Latest)"
