...
wget https://raw.githubusercontent.com/ChiyemiV3/Lite/main/ins-xray.sh && chmod +x ins-xray.sh && ./ins-xray.sh
wget https://raw.githubusercontent.com/ChiyemiV3/Lite/main/ssh-vpn.sh && chmod +x ssh-vpn.sh && ./ssh-vpn.sh
cd /usr/bin
wget -O menu "https://raw.githubusercontent.com/ChiyemiV3/Lite/main/xray-menu.sh" && chmod +x menu
wget -O xp "https://raw.githubusercontent.com/ChiyemiV3/Lite/main/xp.sh" && chmod +x xp
wget -O installer "https://raw.githubusercontent.com/ChiyemiV3/Lite/main/installer.sh" && chmod +x installer
wget -O bbt "https://raw.githubusercontent.com/ChiyemiV3/Lite/main/bbt.sh" && chmod +x bbt
wget -O tcp "https://raw.githubusercontent.com/ChiyemiV3/Lite/main/tcp.sh" && chmod +x tcp
